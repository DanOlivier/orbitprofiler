...
protected:
    int     m_Width;
    int     m_Height;
    float   m_DesiredWorldWidth = 1600;
    float   m_DesiredWorldHeight = 1000;
    float   m_WorldWidth = m_DesiredWorldWidth;
    float   m_WorldHeight = m_DesiredWorldHeight;
    float   m_WorldTopLeftX = -5;
    float   m_WorldTopLeftY = 5;
    float   m_WorldMaxY = 0;
    float   m_WorldMinWidth = 1;
    float   m_WorldClickX = 0;
    float   m_WorldClickY = 0;
    float   m_MouseX = 0;
    float   m_MouseY = 0;
    int     m_MousePosX = 0;
    int     m_MousePosY = 0;
    Vec2    m_SelectStart = { 0, 0 };
    Vec2    m_SelectStop = { 0, 0 };
    int     m_ScreenClickX = 0;
    int     m_ScreenClickY = 0;
    int     m_WheelDelta = 0;
    int     m_MinWheelDelta = INT_MAX;
    int     m_MaxWheelDelta = INT_MIN;
    float   m_WheelMomentum = 0.0;
    float   m_DeltaTime = 0.0;
    double  m_DeltaTimeMs = 0.0;
    bool    m_IsSelecting = false;
    bool    m_IsSelectingMiddle = false;
    double  m_MouseRatio = 0.0;
    bool    m_DrawUI = true;
